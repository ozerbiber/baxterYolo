...
"""autogenerated by genpy from boundingbox_msgs/Boundingboxes.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import boundingbox_msgs.msg
import std_msgs.msg

class Boundingboxes(genpy.Message):
  _md5sum = "d7c7b74ff2f7ee31ef357a5ee6845ead"
  _type = "boundingbox_msgs/Boundingboxes"
...
"""
  ...
  _slot_types = ['std_msgs/Header','boundingbox_msgs/Boundingbox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = boundingbox_msgs.msg.Boundingbox()
        _x = val1
        start = end
        end += 24
