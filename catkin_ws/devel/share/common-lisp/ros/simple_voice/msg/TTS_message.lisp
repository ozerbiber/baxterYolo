...
(cl:in-package simple_voice-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <TTS_message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TTS_message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simple_voice-msg:<TTS_message> is deprecated: use simple_voice-msg:TTS_message instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <TTS_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_voice-msg:header-val is deprecated.  Use simple_voice-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'engine-val :lambda-list '(m))
(cl:defmethod engine-val ((m <TTS_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_voice-msg:engine-val is deprecated.  Use simple_voice-msg:engine instead.")
  (engine m))

(cl:ensure-generic-function 'sentence-val :lambda-list '(m))
(cl:defmethod sentence-val ((m <TTS_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_voice-msg:sentence-val is deprecated.  Use simple_voice-msg:sentence instead.")
  (sentence m))

(cl:ensure-generic-function 'language-val :lambda-list '(m))
(cl:defmethod language-val ((m <TTS_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_voice-msg:language-val is deprecated.  Use simple_voice-msg:language instead.")
  (language m))

(cl:ensure-generic-function 'engine_settings-val :lambda-list '(m))
(cl:defmethod engine_settings-val ((m <TTS_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_voice-msg:engine_settings-val is deprecated.  Use simple_voice-msg:engine_settings instead.")
  (engine_settings m))

(cl:ensure-generic-function 'speaker_settings-val :lambda-list '(m))
(cl:defmethod speaker_settings-val ((m <TTS_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_voice-msg:speaker_settings-val is deprecated.  Use simple_voice-msg:speaker_settings instead.")
  (speaker_settings m))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <TTS_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_voice-msg:time-val is deprecated.  Use simple_voice-msg:time instead.")
  (time m))
